      ...
      <header class="navbar navbar-expand-md d-print-none" >
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
              <img src="./static/logo.svg" width="110" height="32" alt="2sr.in" class="navbar-brand-image">
            </a>
          </h1>
          ...
          <div class="container-xl">
            <div class="row row-cards">
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card card-md">
                  <div class="card-body text-center">
                    <div class="text-uppercase text-muted font-weight-medium">Web</div>
                    ...
                    <div class="text-center mt-4">
                      <a href="./app/admin" class="btn w-100">Admin</a>
                    </div>
                    <div class="text-center mt-4">
                      <a href="./app/student/" class="btn w-100">Student</a>
                    </div>
                    <div class="text-center mt-4">
                      <a href="#" class="btn w-100">Counsiler</a>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-sm-6 col-lg-3">
                <div class="card card-md">
                  <div class="card-body text-center">
                    <div class="text-uppercase text-muted font-weight-medium">Mobile App</div>
                    ...
                    <div class="text-center mt-4">
                      <a href="./download/android_app.apk" class="btn w-100">Download App</a>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card card-md">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <h2 class="h3">Currently Working On:</h2>
                        <p class="m-0 text-muted">Counsiler Pannel and Payement System.</p>
                      </div>
                      <div class="col-auto">
                        <a href="#" class="btn">
                          ETA: None
